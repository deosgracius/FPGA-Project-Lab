...
#set_property PACKAGE_PIN T18 [get_ports reverse]                                   
...
##Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {IN4}]                          
      set_property IOSTANDARD LVCMOS33 [get_ports {IN4}]
##Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {ENA}]                          
      set_property IOSTANDARD LVCMOS33 [get_ports {ENA}]
##Sch name = JB7
#set_property PACKAGE_PIN A15 [get_ports {JB[4]}]                             
      #set_property IOSTANDARD LVCMOS33 [get_ports {JB[4]}]
##Sch name = JB8
set_property PACKAGE_PIN A17 [get_ports {S0}]                           
      set_property IOSTANDARD LVCMOS33 [get_ports {S0}]
##Sch name = JB9
set_property PACKAGE_PIN C15 [get_ports {S1}]                           
      set_property IOSTANDARD LVCMOS33 [get_ports {S1}]
##Sch name = JB10
set_property PACKAGE_PIN C16 [get_ports {S2}]                           
...
##Pmod Header JC
##Sch name = JC1
#set_property PACKAGE_PIN K17 [get_ports {S1}]                          
#set_property IOSTANDARD LVCMOS33 [get_ports {S1}]
##Sch name = JC2
...
#set_property IOSTANDARD LVCMOS33 [get_ports {IN2}]
##Sch name = JC4
set_property PACKAGE_PIN P18 [get_ports {ENB}]                          
...
##Sch name = JC9
set_property PACKAGE_PIN P17 [get_ports {IN1}]                          
set_property IOSTANDARD LVCMOS33 [get_ports {IN1}]
##Sch name = JC10
#set_property PACKAGE_PIN R18 [get_ports {ENA}]                         
#set_property IOSTANDARD LVCMOS33 [get_ports {ENA}]
